...
<body>
	...
	<table>
	  ...
	  <?php
	  $record = "SELECT * FROM facility_list";
	  ...
	  <tr>
	    ...
	    <td><?php echo $data['fRate'];?></td>
	    <td class = "tengah"><a href="edit.php?ID=<?php echo $data['ID'];?>">edit</a></td>
	    <td  class = "tengah"><a href="delete.php?ID=<?php echo $data['ID'];?>"onclick="return confirm('Are you sure you want to delete'); ">delete</a></td>
